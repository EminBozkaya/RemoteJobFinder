...
internal static class GoldSet
{
    ...
    public static IEnumerable<GoldCase> Cases()
    {
        ...
        yield return new("employee-via-eor-soft", F(eor: true, eng: EngagementType.EmployeeViaEor, conf: 0.75), Decision.Eligible);
        ...
        yield return new("b2b-rejected-but-profile-wants", F(allowsB2B: false, conf: 0.8), Decision.Uncertain);
    ...
    private static EligibilityFacts F(
        ...
        new(
            ...
            RequiresWorkAuth: workAuth, AllowedCountries: allowed, RequiresCitizenship: citizenship,
